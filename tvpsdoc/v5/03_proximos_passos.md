...
Quando o script é executado em uma barra histórica, a variável [fechar](https://www.tradingview.com/pine-script-reference/v5/#var_close) (_close_), embutida, contém o valor do _fechamento_ daquela barra. Quando o script é executado na barra em tempo real, o [fechar](https://www.tradingview.com/pine-script-reference/v5/#var_close) (_close_) retorna o preço __corrente__/__atual__ do símbolo até que a barra se fecha.
